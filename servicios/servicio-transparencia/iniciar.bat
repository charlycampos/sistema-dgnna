@echo off
echo ============================================
echo  Microservicio: Ley de Transparencia - Puerto 8006
echo ============================================
...
for /f "tokens=5" %%p in ('netstat -ano ^| findstr ":8006 .*LISTENING" 2^>nul') do (
    taskkill /PID %%p /F >nul 2>&1
)

echo.
echo  Servidor listo en http://localhost:8006
