@echo off
echo ============================================
echo  Microservicio: Proyectos de Ley - Puerto 8005
echo ============================================
...
for /f "tokens=5" %%p in ('netstat -ano ^| findstr ":8005 .*LISTENING" 2^>nul') do (
    taskkill /PID %%p /F >nul 2>&1
)

echo.
echo  Servidor listo en http://localhost:8005
