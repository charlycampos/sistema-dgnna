...
const MODULOS_DISPONIBLES = [
  ...
  { id: 'tableros-direcciones', label: 'Tableros Direcciones Línea', desc: 'Monitoreo DSLD, DPNNA, DPE, DA', icon: LayoutDashboard, color: 'text-blue-800 bg-blue-50 border-blue-200' },
